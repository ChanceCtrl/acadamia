...
/**
   ...
   *
   * When using a vectorized version, provide a little bit of padding after the
   end of
   * a buffer (3 words) because the vectorized code may read a little bit after
   the end
   ...
   *
   * The library is released in source form. It is strongly advised to compile
   the library using -Ofast to
   ...
   * Simply include this file. If you don't want to include everything, you can
   also rely
   ...
   * - ARM_MATH_HELIUM:
   *
   * It implies the flags ARM_MATH_MVEF and ARM_MATH_MVEI and
   ARM_MATH_MVE_FLOAT16.
   *
   * - ARM_MATH_HELIUM_EXPERIMENTAL:
   *
   * Only taken into account when ARM_MATH_MVEF, ARM_MATH_MVEI or
   ARM_MATH_MVE_FLOAT16 are defined.
   ...
   * |\b CMSIS\\DSP\\Include           | DSP_Lib include files for using and
   building the lib
   * |\b CMSIS\\DSP\\PrivateInclude    | DSP_Lib private include files for
   building the lib                                               |
